    ...
    <section class="max-bg-gray-100  mt-32">
        <div class="container mx-auto px-8 py-12">
            ...
            <div class="mt-6 flex justify-center">
                <a href="/createalbum"><button type=""
                        class="px-4 py-2 bg-purple-600 font-fontutama text-white rounded hover:bg-red-600">Create New
                        Album</a></button>
            </div>
            <!-- Album Grid -->
                    ...
                    <div class="bg-white rounded overflow-hidden shadow-lg">
                        <a href="/detailalbum/{{ $album->id }}">
                            ...
                            <div class="p-4 flex justify-between">
                                ...
                                <a href="/deletalbum/{{ $album->id }}"
                                    onclick="return confirm('Apakah Anda yakin ingin menghapus album ini?')"
                                    class="inline-flex items-center bg-red-700 hover:bg-red-800 focus:bg-red-800 focus:outline-none focus:ring-2 focus:ring-red-300 text-white font-medium rounded-lg text-xs px-2 py-1 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
            ...
            <!-- <div class="mt-12">
                ...
                <form action="#" method="POST" class="max-w-md">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="albumDescription" id="albumDescription" rows="4"
