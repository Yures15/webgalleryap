        ...
        <div class="container mx-auto mt-10 create-album-form bg-white rounded-lg shadow-md p-8 max-w-md">
            ...
            <form action="/buat-album" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nama_album" id="" class="border border-gray-300 focus:outline-none focus:border-blue-500 rounded-md w-full px-4 py-2" placeholder="Enter album name">
                </div>
                <div class="mb-4">
                    <label class="font-fontdua block text-sm font-semibold text-gray-600">Description:</label>
                    <textarea name="deskripsi" id="" rows="4" class="border border-gray-300 focus:outline-none focus:border-blue-500 rounded-md w-full px-4 py-2" placeholder="Enter album description"></textarea>
                </div>
                ...
                focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" name="foto" id="file_input" type="file">
                <div class="mt-6 flex justify-center">
                    <button type="submit" class="font-fontutama px-4 py-2 bg-pink-400 text-white rounded-md hover:bg-red-600 focus:outline-none focus:bg-blue-600">Create Album</button>
                </div>
            </form>
        </div>
