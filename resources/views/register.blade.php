    ...
    <section class="mt-32">
        <div class="max-w-[364px] bg-blue-100 rounded-md shadow-md mx-auto px-6 py-4">
            ...
            <div class="flex flex-col">
                <div class="flex items-center">
                    <img src="/assets/ryukyu-gallery-high-resolution-logo-transparent (1).png" alt="" class="w-10 h-10">
                    <h3 class="text-2xl font-fontutama text-red-600 ml-2">RyuKyu Gallery Register</h3>
                </div>

                <h4 class="font-fontutama mt-3">Username</h4>
                <input type="text" class="border py-1 rounded-md text-slate-700 p-3" name="username" placeholder="Input Username...">
                @error('username')
                    <small class="italic text-red-800">{{$message}}</small>
                @enderror
                <h4 class="font-fontutama mt-3">Email</h4>
                <input type="text" class="border py-1 rounded-md text-slate-700 p-3" name="email" placeholder="Input Email...">
                @error('email')
                    <small class="italic text-red-800">{{$message}}</small>
                @enderror
